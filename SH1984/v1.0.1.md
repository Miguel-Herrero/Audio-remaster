> **Nota (v2.0.0):** el paso 1 de este documento dice que el audio ingles
> se extrae de `4K.mkv`. Eso es un error de redaccion: el remaster 4K es
> un upscale de YouTube con audio Opus (lossy) que nunca se ha usado como
> fuente de audio — en la practica siempre se extrajo del Blu-ray. Ver
> `SH1984/v2.0.0.md` para el proceso corregido y automatizado.
